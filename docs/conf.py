...
latex_documents = [
    (master_doc, "python_template.tex", "python_template Documentation",
     "Tim Paine", "manual"),
]
...
texinfo_documents = [
    (master_doc, "python_template", "python_template Documentation",
     author, "python_template", "A pure-python project template",
     "Miscellaneous"),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "python_template"))
